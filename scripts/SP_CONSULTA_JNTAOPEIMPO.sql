...
R24.CCLBLM,
CASE  R24.CCLBLM
WHEN ''BUL'' THEN SUM(R24.NBLTMN)
ELSE 1
END AS NBLTMN,
CASE  R24.CCLBLM
WHEN ''BUL'' THEN SUM(R24.PBRKLM)
WHEN ''CTN'' THEN 
		CASE 
		WHEN (SELECT COUNT(r.NORSRN) FROM "DC@RNSLIB".RZIT24 r WHERE r.NORSRN = r22.NORSRN AND r.SESTRG = ''M'' AND r.CPRCN3 = r24.CPRCN3 AND r.NSRCN3 = r24.NSRCN3) = 1 THEN (SELECT SUM(r.PBRKLM) FROM "DC@RNSLIB".RZIT24 r WHERE r.NORSRN = r22.NORSRN AND r.SESTRG = ''M'' AND r.CPRCN3 = r24.CPRCN3 AND r.NSRCN3 = r24.NSRCN3)
		ELSE  (SELECT SUM(r.PBRKLM) FROM "DC@RNSLIB".RZIT24 r WHERE r.NORSRN = r22.NORSRN AND r.SESTRG = ''A'' AND r.CPRCN3 = r24.CPRCN3 AND r.NSRCN3 = r24.NSRCN3)
		END
ELSE 1
END AS PBRKLM, 
R24.NBLRCR,
